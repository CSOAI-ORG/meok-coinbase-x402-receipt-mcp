...
[![MCP Scorecard: 90/100](https://img.shields.io/badge/proofof.ai-90%2F100-5b21b6)](https://proofof.ai/scorecard/meok-coinbase-x402-receipt-mcp.html)
...
```json
{
  "mcpServers": {
    "meok-coinbase-x402-receipt-mcp": {
      "command": "uvx",
      "args": ["meok-coinbase-x402-receipt-mcp"]
    }
  }
}
```

Or: `pip install meok-coinbase-x402-receipt-mcp` then run the `meok-coinbase-x402-receipt-mcp` command (stdio transport).
